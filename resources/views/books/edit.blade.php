...
<section class="login books">
    ...
    <section class="body_container login books">
        ...
        <form action="/books/edit" class="form" method="POST">
            ...
            <input type="text" name="title" class="form_input" placeholder="{{$book->title}}">

            <label for="sub_title" class="title">Subtítulo do livro</label>
            <input type="text" name="sub_title" class="form_input" placeholder="{{$book->sub_title}}">

            <label for="author" class="title">Nome do autor</label>
            <input type="text" name="author" class="form_input" placeholder="{{$book->author}}">

            <label for="issue" class="title">Edição</label>
            <input type="number" name="issue" class="form_input" placeholder="{{$book->issue}}">

            <label for="publisher" class="title">Editora</label>
            <input type="text" name="publisher" class="form_input" placeholder="{{$book->publisher}}">

            <label for="date" class="title">Data de lançamento</label>
            <input type="date" name="date" class="form_input" placeholder="{{$book->date_of_publish}}">

            <label for="cover_url" class="title">Url da imagem de capa</label>
            <input type="text" name="cover_url" class="form_input" placeholder="{{$book->cover_url}}">
